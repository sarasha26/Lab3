...
document.write(`The first score was ${score2} <br/>`);
document.write(`The first score was ${score3} <br/>`);
document.write(`The average of the three scores is ${total.toFixed(2)}`);
